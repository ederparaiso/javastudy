package org.eder.learning.ws.rest;
...
class LibraryClient {
	...
	public static void main(String[] args) throws Exception {
		String book1 = "<?xml version=\"1.0\"?>"
				+ "<book isbn=\"0201548550\" pubyear=\"1992\">" + " <title>"
				+ " Advanced C+" + " </title>" + " <author>"
				+ " James O. Coplien" + " </author>" + " <publisher>"
				+ " Addison Wesley" + " </publisher>" + "</book>";
		doPost(book1);
		String book2 = "<?xml version=\"1.0\"?>"
				+ "<book isbn=\"9781430210450\" pubyear=\"2008\">" + " <title>"
				+ " Beginning Groovy and Grails" + " </title>" + " <author>"
				+ " Christopher M. Judd" + " </author>" + " <author>"
				+ " Joseph Faisal Nusairat" + " </author>" + " <author>"
				+ " James Shingler" + " </author>" + " <publisher>" + " Apress"
				+ " </publisher>" + "</book>";
		doPost(book2);
		doGet(null);
		doGet("0201548550");
	...
	static void doPost(String xml) throws Exception {
		...
		if (httpurlc.getResponseCode() == 200) {
			...
			System.err.println("cannot insert book: "
					+ httpurlc.getResponseCode());
		System.out.println();
	}
	...
	static void doPut(String xml) throws Exception {
		...
		if (httpurlc.getResponseCode() == 200) {
			...
			System.err.println("cannot update book: "
					+ httpurlc.getResponseCode());
		System.out.println();
	}
}
